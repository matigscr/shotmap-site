...
export function ParallaxWrapper() {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden" aria-hidden="true">
      <BackgroundBase />
      <GridOverlay y={gridY} opacity={backgroundOpacity.grid} reduceMotion={shouldReduceMotion} />
      <SchematicLayer
        x={shouldReduceMotion ? undefined : schematicX}
        y={shouldReduceMotion ? undefined : schematicY}
        scale={shouldReduceMotion ? undefined : schematicScale}
        intensity="quiet"
